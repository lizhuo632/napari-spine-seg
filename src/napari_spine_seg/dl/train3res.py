...
weight_path = "/share/data/CryoET_Data/lizhuo/SIM-data/traindata/weights3res"
data_path = "/share/data/CryoET_Data/lizhuo/SIM-data/traindata"
save_path = "/share/data/CryoET_Data/lizhuo/SIM-data/traindata/saveimg3res"
epoch = 1
epoch_num = 600
continueflag = False
b = 0
...
if __name__ == "__main__":
    ...
    plt.plot(x, y2, color="blue", label="val_loss")
    plt.legend()
    plt.savefig(os.path.join(save_path, "loss", "1loss.png"))

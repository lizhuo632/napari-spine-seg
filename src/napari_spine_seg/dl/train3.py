...
weight_path = (
    "/share/data/CryoET_Data/lizhuo/SIM-data/mem/mem-spine+filo/weights3"
)
data_path = "/share/data/CryoET_Data/lizhuo/SIM-data/mem/mem-spine+filo"
save_path = (
    "/share/data/CryoET_Data/lizhuo/SIM-data/mem/mem-spine+filo/saveimg3"
)
epoch = 1
epoch_num = 600
continueflag = False
